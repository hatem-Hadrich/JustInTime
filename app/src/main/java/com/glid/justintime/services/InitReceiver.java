...
public class InitReceiver extends BroadcastReceiver {
    ...
    // this value allows to periodically call the service each ic_diary_type_1 minute (the
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        // explicit intent
        Intent reminderSchedulerIntent = new Intent(ctx, SchedulerReceiver.class);
        ...
        // add ic_diary_type_1 minute, we will verify reminders each minute
